...
namespace RealifeGM.de.jojoa.methods
{
    class stringMethods
    {
        public static string console_prefix = "GTA Universe - ";
        public static string main_prefix = "~g~GTA Universe ~w~- ";
        ...
        public static string[] register_msg = { main_prefix + "Herzlich Willkommen, %name%.", main_prefix + "Wir konnten dich nicht in unserer Datenbank finden!", main_prefix + "Bitte registriere dich nun, indem du das Formular befolgst." };
